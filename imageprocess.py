...
def mergeKill(image1, image2, playername, victimname):
    width = 1300
    height = 850
    ...
    text = playername
    center_text(background, title_font, text, strip_width, strip_height, 0)

    strip_width, strip_height = 600, 50
    text = victimname
    center_text(background, title_font, text, strip_width, strip_height, 700)

    strip_width, strip_height = 100, 50
    text = 'Killed'
    center_text(background, title_font, text, strip_width, strip_height, 600)
...
def center_text(img, font, text, strip_width, strip_height, offset, color=(54, 69, 79)):
    draw = ImageDraw.Draw(img)
    text_width, text_height = draw.textsize(text, font)
    position = ((strip_width-text_width)/2 + offset,(strip_height-text_height)/2)
