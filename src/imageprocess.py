...
def mergeKill(image1, image2, playername, victimname, fame, killip, victimip):
    ...
    title_font = ImageFont.truetype('rec/sanstext.ttf', 30)
    title_fontsmall = ImageFont.truetype('rec/sanstext.ttf', 26)
    title_fontsmaller = ImageFont.truetype('rec/sanstext.ttf', 14)
